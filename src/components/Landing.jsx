        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center'>
          ...
          <nav>
            <ul className='flex space-x-4'>
              <li>
                <a
                  onClick={() => navigate('/login-page?mode=login')}
              ...
              <li>
                <a
                  onClick={() => navigate('/login-page?mode=signup')}
                  className='text-gray-600 hover:text-gray-900 cursor-pointer'
                >
                  Signup
                </a>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='bg-gray-100 p-6 rounded-lg shadow-md'>
                ...
                <p className='text-gray-600'>
                  Enter your criteria and get the jobs that best match your
              ...
              <div className='bg-gray-100 p-6 rounded-lg shadow-md'>
                ...
                <p className='text-gray-600'>
                  We filter through listings to present only the most relevant
              ...
              <div className='bg-gray-100 p-6 rounded-lg shadow-md'>
                ...
                <p className='text-gray-600'>
                  Direct links to job postings allow you to apply instantly to
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='bg-white p-6 rounded-lg shadow-md'>
                ...
                <p className='text-gray-600'>
                  Input your preferred position and location.
                </p>
              </div>
              <div className='bg-white p-6 rounded-lg shadow-md'>
                <div className='flex items-center justify-center w-12 h-12 bg-gray-800 text-white rounded-full mb-4 text-xl font-bold'>
                ...
                <p className='text-gray-600'>
                  Our app then find and lists job postings others could have
                  missed.
                </p>
              </div>
              <div className='bg-white p-6 rounded-lg shadow-md'>
                ...
                <p className='text-gray-600'>
                  Click on the provided links to go straight to the application
                  page.
                </p>
              </div>
            </div>
