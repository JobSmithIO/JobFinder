              ...
              <form onSubmit={handleSubmit} className='mx-auto max-w-xs'>
                <input
                  className={`w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border ${
                    isEmailError ? 'border-red-500' : 'border-gray-200'
                ...
                <div className=' text-sm text-gray-600 tracking-wide font-medium bg-white text-center'>
                  Dont have an accout?
                </div>
                <br></br>
                <div className='flex justify-center items-center h-full'>
                  <a
                    ...
                    className='text-gray-600 hover:text-gray-900 cursor-pointer text-center'
                  >
                    Sign up
                  </a>
                </div>
